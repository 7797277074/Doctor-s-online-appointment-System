...
<head>
    ...
    <title>YouCare Healthcare</title>
                ...
                <div id="site-logo" class="clearfix">
                    <div id="site-logo-inner">
                        <a href="index.php" title="Medical" rel="home" class="main-logo">
                            <img src="assets/img/logo.png" alt="Medical" data-retina="assets/img/logo.png" width="100" height="44" data-width="100" data-height="44">
                        </a>
                    </div>
                </div><!-- /#site-logo -->
        ...
        <ul>
            ...
            <li data-transition="random">
                ...
                <div class="tp-caption tp-resizeme text-white text-left font-heading font-weight-600"
                    ...
                    Online Doctor Appointment Booking System <br>
                    Welcome to our YouCare Healthcare
                </div>
    ...
    <div id="bottom-bar-inner" class="wprt-container">
        <div class="bottom-bar-inner-wrap">
            <div class="bottom-bar-content">
                <div id="copyright">
                    &copy; <?php echo date('Y');?> Online Doctor Appointment Booking System, All rights reserved | Powered By
