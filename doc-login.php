        ...
        <div class="main-content container-fluid">
          <div class="splash-container">
            <div class="card card-border-color card-border-color-primary">
              <div class="card-header"><img class="logo-img" src="assets/img/logo-xx.png" alt="logo" width="{conf.logoWidth}" height="60"><span class="splash-description">Please enter your user information.</span></div>
              <div class="card-body">
            ...
            <div class="splash-footer">&copy; <?php echo date ('Y');?> Online Doctor Appointment Booking System | Powered By <a href = "" target ="_blank" >YouCare</a></div>
          </div>
        </div>
      </div>
    </div>
